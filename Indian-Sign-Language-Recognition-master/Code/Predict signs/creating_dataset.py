        ...
        if frame is not None:
            ...
            if method == 1:
                ...
                if (num_frames < 30):
                    ...
                    cv2.putText(clone, "Put your hand in the rectangle", (10, 100), cv2.FONT_HERSHEY_COMPLEX, 0.5,
                                (0, 0, 0))
                    cv2.putText(clone, "Press the key of the sample", (10, 150), cv2.FONT_HERSHEY_COMPLEX, 0.5,
                                (0, 0, 0))
            ...
            if method == 2:
                ...
                cv2.putText(clone, "Adjust the values using trackbar", (10, 100), cv2.FONT_HERSHEY_COMPLEX, 0.5,
                            (0, 0, 0))
