    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label4 = Label(f2, text="                            Indian Sign Language Recognition System",
                               font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                statusbar = Label(f1, text="                            Indian Sign Language Recognition System",
                                  font=("arial", 8, "bold"),
                ...
                if __name__ == "__main__":
                    l = AnimatedGIF(f1, "files/gif3.gif")
                    l.pack()

                label4 = Label(f3, text="                            Indian Sign Language Recognition System",
                               font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
