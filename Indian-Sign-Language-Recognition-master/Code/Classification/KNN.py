...
# Original file is located at https://colab.research.google.com/drive/11wxkApXc-8qfHMEj2v2bAHzYmDjmCuUD
...
plt.plot(range(1, 20), accuracy_rate, color='blue', linestyle='dashed', marker='o', markerfacecolor='red',
         markersize=10)
