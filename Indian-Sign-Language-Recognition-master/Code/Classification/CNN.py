...
# Original file is located at https://colab.research.google.com/drive/1csqfNQ1OrJnix3DXxURsxKtNpzVvw57q
...
history = model.fit(train_images, train_labels_one_hot, batch_size=batch_size, epochs=epochs, verbose=1,
